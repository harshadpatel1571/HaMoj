...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 453059953, ; hash 0x1b012571, from name: libaot-HamojApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1430656168, ; hash 0x554614a8, from name: aot-HamojApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HamojApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 154
	...
	%struct.DSOCacheEntry {
		i64 1633729875, ; hash 0x6160bd53, from name: aot-HamojApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HamojApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 168
	...
	%struct.DSOCacheEntry {
		i64 2225715321, ; hash 0x84a9b879, from name: HamojApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HamojApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 245
	...
	%struct.DSOCacheEntry {
		i64 3335729082, ; hash 0xc6d32fba, from name: libaot-HamojApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HamojApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 381
	...
	%struct.DSOCacheEntry {
		i64 3389347888, ; hash 0xca055830, from name: HamojApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HamojApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 386
